...
phi2    = 0.05          #Thiele modulus
n       = 1                #order of the reaction
Co      = 1                #Initial concentration
To      = 300              #Initial Temperature
k       = 0.000005            #Rate constant 1/s first orde reaction

D       = 0.001           #Diffusion coefficient
keff    = 1             #Thermal diffusion coefficient
A       = 1          #Arrhenius coefficient
Ea      = 1             #Activation energy
R       = 8.314            #Universal gas constant
delH    = -1000            #heat of reaction
